...
public class SocketServerMultiplexIO {
     ...
     * 日志
     */
    private static final Log LOGGER = LogFactory.getLog(SocketServerMultiplexIO.class);
            ...
            while(true) {
                ...
                while(selecionKeys.hasNext()) {
                    ...
                    if(readyKey.isValid() && readyKey.isAcceptable()) {
                        SocketServerMultiplexIO.LOGGER.info("======channel通道已经准备好=======");
                        /*
                        ...
                        SocketServerMultiplexIO.LOGGER.info("======socket channel 建立连接=======");
                    } else if(readyKey.isValid() && readyKey.isReadable()) {
                        SocketServerMultiplexIO.LOGGER.info("======socket channel 数据准备完成，可以去读==读取=======");
                        readSocketChannel(readyKey);
                    }
                }
            }
        } catch(Exception e) {
            SocketServerMultiplexIO.LOGGER.error(e.getMessage() , e);
        } finally {
            serverSocket.close();
        }
    }
    ...
    private static void readSocketChannel(SelectionKey readyKey) throws Exception {
        ...
        try {
            ...
            SocketServerMultiplexIO.LOGGER.error(e.getMessage());
        ...
        if(realLen == -1) {
            SocketServerMultiplexIO.LOGGER.warn("====缓存区没有数据？====");
            return;
        }
        ...
        if(message.indexOf("over") != -1) {
            ...
            contextBytes.clear();
            SocketServerMultiplexIO.LOGGER.info("端口:" + resoucePort + "客户端发来的信息======message : " + message);
            ...
            SocketServerMultiplexIO.LOGGER.info("端口:" + resoucePort + "客户端信息还未接受完，继续接受======message : " + message);
